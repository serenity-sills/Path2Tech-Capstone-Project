...
const Policy = () => {
  return (
    ...
    <p> DevelopHer's offers USPS Priority mail shipping. Once an order is placed processing will occur within 2-5 business days. Please allow 2-10 business days from the time of purchase for your order to be shipped and delivered. Shipping time excludes weekends and holidays.
        ...
        If a package is marked as "undeliverable" and/or "unclaimed" and is returned to DevelopHer's we will process the customer a full refund, minus the cost of shipping. We will not re-send the package.
        </p>
